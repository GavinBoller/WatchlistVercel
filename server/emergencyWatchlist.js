...
exports.getEmergencyWatchlist = getEmergencyWatchlist;
var storage_1 = require("./storage");
function getEmergencyWatchlist(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, entries, watchlist, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('[EmergencyWatchlist] Error fetching watchlist:', error_1);
